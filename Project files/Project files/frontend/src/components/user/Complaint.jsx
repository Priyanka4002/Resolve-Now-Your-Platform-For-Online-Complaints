   ...
   return (
      <>
         <div className="text-white complaint-box">
            <form onSubmit={handleSubmit} className="compliant-form row bg-secondary ">
               ...
               <div className="text-center p-1 col-12">
                  <button type="submit" onClick={handleSubmit} className="mt-2 btn btn-info">Register</button>
               </div>
            </form>
         </div>
      </>
